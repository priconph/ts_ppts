...
class CreateProductionRuncardsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('production_runcards', function (Blueprint $table) {
            ...
            // $table->unsignedTinyInteger('shift')->default(1)->comment = '1-Shift A, 2- Shift B';
            ...
            $table->string('assessment_no', 25)->nullable();
            // $table->string('po_no', 25);
            // $table->integer('po_qty')->default(0);
            $table->string('a_drawing_no', 25)->nullable();
            $table->string('a_drawing_rev', 25)->nullable();
            $table->string('g_drawing_no', 25)->nullable();
            $table->string('g_drawing_rev', 25)->nullable();
            $table->string('other_docs_no', 25)->nullable();
            $table->string('other_docs_rev', 25)->nullable();

            $table->string('mold')->nullable();
            $table->string('ct_supplier')->nullable();

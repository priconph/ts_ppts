...
@auth
                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="float-right">
                      ...
                      <button class="btn btn-primary btn-sm" id="btnShowAddProdRuncard"><i class="fa fa-plus"></i> Add Lot Application</button>
                    </div>
                    <br><br>
              ...
              <div class="row">
                <div class="col">
                  <div class="input-group input-group-sm mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm" name="quantity" required readonly>
                  </div>
                </div>
              </div>
              <div class="row">
  ...
  <script type="text/javascript">
    ...
    var img_barcode_lot_po;
    var img_barcode_lot;
    var lbl_lot_po;
    var lbl_lot;
    var lbl_lot_device_name; 
    var lbl_lot_qty;
        ...
        $.ajax({
          ...
          success     : function(data){
              ...
              if(data['result'] == 1){
                ...
                toastr.error('FVI', 'Saving Failed!');
                if(data['error'] != null){
...
/*    $("#btn_print_barcode").click(function(){
      popup = window.open();
        ...
        content += '<tr>';
            ...
            content += '<label style="font-weight: bold;">' + lbl_PO + '</label>';
            content += '<br>';
 ...
 $("#btn_print_barcode").click(function(){
  ...
  $("#btn_print_lot_barcode").click(function(){
        ...
        content += '<body>';
          ...
          content += '<br><label style="text-align: center; font-weight: bold; font-family: Arial; font-size: 5px;">' +  $('#lbl_lot_PO').text() + '</label>';
          content += '<br><label style="text-align: center; font-weight: bold; font-family: Arial; font-size: 5px;">' +$('#lbl_lot_device_name').text() + '</label>';
           content += '</center>';
          content += '</td>';
          ...
          content += '<br><label style="text-align: center; font-weight: bold; font-family: Arial; font-size: 5px;">' + $('#lbl_lot_no').text() + '</label>';
          content += '<br><label style="text-align: center; font-weight: bold; font-family: Arial; font-size: 5px;">' + $('#lbl_lot_qty').text() + '</label>';
          content += '</center>';
          content += '</td>';
          content += '</tr>';

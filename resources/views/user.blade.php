...
<!--                     <button class="btn btn-primary" data-keyboard="false" id="btnShowModalPrintBatchUser" disabled><i class="fa fa-print"></i> Print Batch QR Code (<span id="lblNoOfPrintBatchSelUser">0</span>)</button>
 -->
                    @if(Auth::user()->user_level_id == 1)
                      <button class="btn btn-primary" data-toggle="modal" data-target="#modalImportUser" id="btnShowImport" title="Import User"><i class="fa fa-file-excel"></i> Import</button>
                    @endif
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  <label>Name (FN MI. LN)</label>
                    <input type="text" class="form-control" name="name" id="txtAddUserName" autocomplete="off">
                </div>

                <div class="form-group">
                  <label>Username</label>
                    <input type="text" class="form-control" name="username" id="txtAddUserUserName" autocomplete="off">
                </div>

<!--                 <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6">
                        <input type="checkbox" name="with_email" id="chkAddUserWithEmail">
                        <label>Email</label>
                      </div>
                      <div class="col-sm-6">
                        <input type="checkbox" name="send_email" id="chkAddUserSendEmail">
 ...
 -->
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="employee_id" id="txtAddUserEmpId" style="text-transform:uppercase">
                </div>
                ...
                <div class="form-group">
                  <label>Final Visual Operator No.</label>
                    <input type="text" class="form-control" name="fvi_no" id="txtAddUserFVONo">
                </div>
...
<!--                       <option value="5">Inspector</option>
 ...
 -->                    </select>
                ...
                <div class="form-group">
                  <label>Employee ID</label>
                    <input type="text" class="form-control" name="employee_id" id="txtEditUserEmpId" style="text-transform:uppercase">
                </div>
                ...
                <div class="form-group">
                  <label>Final Visual Operator No.</label>
                    <input type="text" class="form-control" name="fvi_no" id="txtEditUserFVONo">
                </div>
        ...
        "processing" : false,
          ...
          "columns":[
            ...
            { "data": 'oqc_stamps',
                ...
                render: {
                  display: function (data, type, row) {
                    // if (row.oqc_stamps != null) {
                    //   return oqc_stamps;
                    // }
                    // else{
                    //   return 'N/A';
                    // }
                    if(row.oqc_stamps.length > 0){
                      return row.oqc_stamps[0].oqc_stamp;
                    }
                    else{
                      return 'N/A';
                    }

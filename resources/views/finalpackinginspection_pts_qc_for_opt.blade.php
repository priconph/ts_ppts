  ...
  $(document).ready(function () {
    ...
    $('#modal_scan_tray_qrcode_3').keypress(function(e) {
      if( e.keyCode == 13 && $('#modal_scan_tray_qrcode_3').val() !='' ){
        ...
        let data = $('#modal_scan_tray_qrcode_3').val().split(/\s+/)
        console.log('web_edi_arr',data)
        // console.log('web_edi_to_validate',dlabel_to_scan)
        ...
        console.log('web_unique_sticker', web_unique_sticker)
        console.log('data', data)
        console.log('unique_sticker_to_match', dlabel_to_scan[5])
        console.log('unique_sticker', data[3])
        console.log('po_number', data[0])

        console.log('match1', unique_sticker)
        console.log('match2', unique_sticker_to_match)
    ...
    // });
     ...
     $('#btnSearchOperator').click(function(){
      ...
      if( pmi_blue_packing_lbl_to_scan[5] == 0 ){
        alert( 'Please scan the PMI PACKING LABEL.' )
        return
      }
    /* 04112025 */
    //   if( dlabel_to_scan[4] == 0 ){
    //     alert( 'Please scan the WEB EDI.' )
    //     return
    //   }

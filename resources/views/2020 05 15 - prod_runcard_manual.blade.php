        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Runcard</li>
              <li class="breadcrumb-item active">New Process</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <div class="col border py-3 px-4 border-left-0 border-bottom-0">
                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active my-2" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <center>
                          <label>Material Kitting & Issuance</label>
                        </center>
                        <div class="row">
                          <!-- <div class="col-sm-3">
                            <div class="input-group input-group-sm">
                              <div class="input-group-prepend">
                                <button type="button" class="btn btn-info btnScanWhsSlipNo" title="Scan Mat't Lot #"><i class="fa fa-qrcode"></i></button>
                              </div>
                              <input type="text" class="form-control" id="txtScannedWHSSlipNo" placeholder="Scan WHS Slip # Code" readonly="true">
                            </div>
                          </div> -->
                          ...
                          <div class="col-sm-3">
                            <div class="input-group input-group-sm">
                              <div class="input-group-prepend">
                                <button type="button" class="btn btn-info btnScanMatKitLot" title="Scan Mat't Lot #"><i class="fa fa-qrcode"></i></button>
                              </div>
                              <input type="text" class="form-control" id="txtScannedMatKitLot" placeholder="Scan Material Lot # Code" readonly="true">
                            </div>
                          </div>
                          ...
                          <div class="col-sm-3">
                            <div class="input-group input-group-sm">
                              <div class="input-group-prepend">
                                <button type="button" class="btn btn-info btnScanEmpNo" title="Scan Operator #"><i class="fa fa-qrcode"></i></button>
                              </div>
                              <input type="text" class="form-control" id="txtScannedEmployeeNo" placeholder="Scan Operator # Code" readonly="true">
                            </div>
                          </div>
                          ...
                          <!-- <div class="col-sm-3 offset-3">
                            <div class="input-group input-group-sm">
                              <div class="input-group-prepend">
                                <button type="button" class="btn btn-success btnClearMatKitLot" title="Clear and Show Saved Material"><i class="fa fa-list"></i></button> 
                              </div>
                              <input type="text" class="form-control" id="txtClearMatKitLot" placeholder="Clear and Show Saved Material" readonly="true">
                            </div>
                          </div> -->
                        ...
                        <div class="row">
                          <div class="col-sm-3">
                            <div class="input-group input-group-sm">
                              <div class="input-group-prepend">
                                <button type="button" class="btn btn-success btnSearchMatKitLot" title="Search Mat't Lot #"><i class="fa fa-search"></i></button>
                              </div>
                              <input type="text" class="form-control" id="txtSearchedMatKitLot" placeholder="Search Material Lot # Code" readonly="true">
                            </div>
                          </div>

                          <div class="col-sm-3">
                            <div class="input-group input-group-sm">
                              <button type="button" class="btn btn-sm btn-success btnShowSavedMatKitLot" title="Show Saved Material"><i class="fa fa-list"></i> Show Saved Material</button>
                            </div>
                          </div>
                      ...
                      <div class="tab-pane fade my-2" id="materialEmbossTab" role="tabpanel" aria-labelledby="emboss-tab">
                        ...
                        <div class="row">
                          <div class="col-sm-3">
                            <div class="input-group input-group-sm">
                              <div class="input-group-prepend">
                                <button type="button" class="btn btn-info btnScanEmbossLot" title="Scan Lot #"><i class="fa fa-qrcode"></i></button>
                              </div>
                              <input type="text" class="form-control" id="txtScannedEmbossLot" placeholder="Scan Lot # Code" readonly="true">
                            </div>
                          </div>

                          <div class="col-sm-3">
                            <div class="input-group input-group-sm">
                              <input type="text" class="form-control" id="txtSearchedManualEmbossLot" placeholder="Search Lot # Code Manually">
                              <div class="input-group-append">
                                <button type="button" class="btn btn-success btnSearchManualEmbossLot" title="Click to Search Lot # Manually"><i class="fa fa-search"></i></button>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-sm-3">
                            <div class="input-group input-group-sm">
                              <div class="input-group-prepend">
                                <button type="button" class="btn btn-success btnSearchEmbossLotNo" title="Search Mat't Lot #"><i class="fa fa-search"></i></button>
                              </div>
                              <input type="text" class="form-control" id="txtSearchedEmbossLotNo" placeholder="Search Material Lot # Code" readonly="true">
                            </div>
                          </div>
                          <br>
                          <div class="col-sm-3">
                            <div class="input-group input-group-sm">
                              <button type="button" class="btn btn-sm btn-success btnShowSavedEmbossLot" title="Show Saved Material"><i class="fa fa-list"></i> Show Saved Material</button>
                            </div>
                          </div>
                        </div>
                ...
                <div class="row">
                  <div class="col border py-3 px-4 border-left-0 border-bottom-0">
                    ...
                    <div class="row align-items-center">
                      <div class="col-sm-8">
                        <span class="badge badge-secondary">3.</span> Process Stations 
                      </div>
    ...
    $(document).ready(function () {
      ...
      dt_materials      = $('#tbl_materials').DataTable({
        "processing" : true,
          "serverSide" : true,
          "ajax" : {
            url: "view_manual_material_kitting_by_runcard",
            data: function (param){
                param.po_number = currentPoNo;
                param.runcard_status = $("#txt_prod_runcard_status").val();
                param.prod_runcard_id_query = $("#txt_prod_runcard_id_query").val();
                param.action = viewMatKitAction;
                param.lot_no = viewMatKitActionLotNo;
            }
          },
          bAutoWidth: false,
          "columns":[
      ...
      dt_prod_runcard_stations = $('#tbl_prod_runcard_stations').DataTable({
        "processing" : true,
          ...
          "columns":[
            ...
            {
                name: 'prod_runcard_station_material_details',
                data: 'prod_runcard_station_material_details',
                sortable: false,
                searchable: false,
                render: function (data) {
                  // console.log(data);
      ...
      $("#txt_edit_prod_runcard_station_ng").keyup(function(){
        ...
        //   // }
        //   // else{
        //   //   tempTotalNumOfMODNGQty += parseFloat($(this).val());
        //   // }

        //   // if($(this).val() != tempTotalNumOfMODNGQty){
        //   //   $("#pRCStatTotNoOfNG").css({color: 'red'});
        //   //   $("#btn_save_prod_runcard_station_stations").prop('disabled', true);
        //   //   $("#pRCStatTotNoOfNG").css({color: 'red'});
        //   // }
        ...
        //   //   $("#pRCStatTotNoOfNG").css({color: 'green'});
        //   // }
        //   // $("#pRCStatTotNoOfNG").text(tempTotalNumOfMODNGQty);
        ...
        // console.log(tempTotalNumOfMODNGQty);
      ...
      $("#tbl_emboss").on('click','.btnSaveEmbossLot',function(e){
        let issuanceId = $(this).attr('issuance-id');
        let itemDesc = $(this).attr('item-desc');
        let item = $(this).attr('item');

        saveEmbossLotIssuanceId = issuanceId;
        saveEmbossLotItem = item;
        saveEmbossLotItemDesc = itemDesc;

        $("#txtSearchPoTransLotNo").val('');
        $("#scanPOTransLotBody").text('Please Scan your ID.');
        $('#modalScanPOTransLotCode').attr('data-formid', 'save_emboss_lot_issuance').modal('show');
      });

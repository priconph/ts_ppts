              ...
              <div class="col-sm-12">
                ...
                <div class="form-group">
                  <label>Boxing/Tray</label>
                    <input type="text" min="1" class="form-control" name="boxing" id="txtAddDeviceBoxing">
                </div>

                <div class="form-group">
                  <label>Shipping Boxing</label>
                    <input type="text" min="1" class="form-control" name="ship_boxing" id="txtAddDeviceShipBoxing">
                </div>
                
                <div class="form-group">
                  <label>Process - Overall Inspection (0 - Without, 1 - With)</label>
                    <input type="text" min="1" class="form-control" name="process" id="txtAddPOI">
                </div>

                <div class="form-group">
                  <label>Type (1 - Burn-In Sockets, 2 - Micron PATS, 3 - Test Sockets)</label>
                    <input type="text" min="1" class="form-control" name="type" id="txtAddType">
                </div>

                <div class="form-group">
                  <label>Label (0 - No (Series Name), 1 - With (Series Name))</label>
                    <input type="text" min="1" class="form-control" name="label" id="txtAddLabel">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="form-group">
                  <label>Process - Overall Inspection (0 - Without, 1 - With)</label>
                    <input type="text" min="1" class="form-control" name="process" id="txtEditPOI">
                </div>

                <div class="form-group">
                  <label>Type (1 - Burn-In Sockets, 2 - Micron PATS, 3 - Test Sockets) </label>
                    <input type="text" min="1" class="form-control" name="type" id="txtEditType">
                </div>

                <div class="form-group">
                  <label>Label (0 - No (Series Name), 1 - With (Series Name))</label>
                    <input type="text" min="1" class="form-control" name="label" id="txtEditLabel">
                </div>
              </div>
            </div>
          </div>

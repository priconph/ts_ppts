...
@section('title', 'Final Packing QC Confirmation')
...
<style type="text/css">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Final Packing QC Confirmation (WEB EDI)</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
            <li class="breadcrumb-item active">Final Packing QC Confirmation (WEB EDI)</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <!-- /.card -->
           ...
           <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">2. Final Packing QC Confirmation Summary</h3>
              </div>
                <div class="card-body">
                   <div class="table-responsive dt-responsive">
                      <table id="tbl_final_inspection_qc_conf" class="table table-bordered table-striped table-hover" style="width: 100%;">
                          <thead>
                            <tr>
                              <th>Action</th>
                              <!-- <th>Packing Code</th> -->
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Final Packing Confirmation - QC (WEB EDI)</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>

      <form id ="formFinalPackingInspection_QC_conf" method="post">
      @csrf
      <input type="hidden" name="finalpacking_mode" value="oqc">
        ...
        <div class="modal-body">
          ...
          <!-- <div class="card card-primary"> -->
            ...
            <div class="card card-primary">
              <div class="card-header">
              <h5 class="card-title">2. Scan WEB EDI (RESPONSIBLE: QC)</h5>
  ...
  $(document).ready(function () {
    ...
    $('#modal_scan_tray_qrcode_2').keypress(function(e) {
     ...
     GetUserList($(".selectUser"));
      ...
      dt_final_inspection = $('#tbl_final_inspection_qc_conf').DataTable({
          "processing"    : false,
          "serverSide"  : true,
          "ajax"        :
          {
            url: "load_finalpacking_pts_qc_table_confirmation",
              data: function (param){
   ...
   $('#btnSubmitInspection').click(function(){
    ...
    // if( is_complete && is_complete_2 ){
      $('#formFinalPackingInspection_QC_conf').submit();
    // }else{s
   ...
   $('#formFinalPackingInspection_QC_conf').submit(function(e){

    e.preventDefault();
    // TSPTSSubmitFinalPackingInspection_QC_conf();
    ...
    $.ajax({
      url: "tspts_submit_final_packing_inspection_qc_web_edi",
      method: "post",
      data: $('#formFinalPackingInspection_QC_conf').serialize() + '&packing_id=' + packing_id + '&box_no=' + box_no + '&po_no=' + po_no + '&qty=' + qty,
      dataType: "json",
      beforeSend: function(){
      ...
      success: function(JsonObject){
        ...
        if(JsonObject['result'] == 1)
        {
          ...
          $('#formFinalPackingInspection_QC_conf')[0].reset();

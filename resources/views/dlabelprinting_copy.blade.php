 		...
 		<div class="container-fluid">
 			<div class="row">
 				...
 				<div class="col-12">
 					...
 					<div>
						<iframe id="iframe_d_label_printing" src="http://rapidx/dlabel_ts_ppts_copy?en={{Auth::user()->employee_id}}&pos={{Auth::user()->position}}"></iframe>

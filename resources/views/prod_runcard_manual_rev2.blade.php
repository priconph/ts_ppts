        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Visual Inspection</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<!--                       <div class="input-group-prepend">
 ...
 -->                      <input type="text" class="form-control" id="txt_po_number_lbl" style="text-transform:uppercase" >
                 ...
                 <div class="col-sm-3 class_txt_yec_po_number_lbl d-none">
                  ...
                  <div class="col-sm-2">
                    <label>Total Lot Qty</label>
                      <input type="text" class="form-control" id="txt_total_no_of_ok" style="color: blue; font-weight: bold;" readonly="">
                  </div>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <button class="btn btn-primary btn-sm" style="float: right;" id="btnShowAddProdRuncard"><i class="fa fa-plus"></i> Add Visual Inspection</button>
              </div>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" class="form-control form-control-sm" id="txt_po_qty" readonly name="txt_po_qty">
                      </div>
                    </div>
                  </div>
                  <!-- <br> -->
                  <div class="row">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" class="form-control form-control-sm" id="txt_use_for_device" readonly name="txt_use_for_device">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" class="form-control form-control-sm" id="txt_lot_no" name="txt_lot_no" placeholder="Auto generated" readonly="readonly">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row row_container">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" value="N/A" class="form-control form-control-sm" id="orig_a_revision" name="orig_a_revision" readonly>
                       </div>
                    </div>
                  </div>
                  ...
                  <div class="row row_container">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        ...
                        <!-- <input type="text" value="N/A" class="form-control form-control-sm" id="txt_JRDJKSDCGJDoc_revision" name="txt_JRDJKSDCGJDoc_revision" readonly> Commented -jd -->
              ...
              <div class="col-sm-8">
                <div class="row">
                  <div class="col border py-3 px-4 border-left-0 border-bottom-0">
                    ...
                    <!-- </div> -->
                    <div style="float: right;">
                      <button class="btn btn-primary btn-sm" id="btnAddProcess" ><i class="fa fa-plus" ></i> Add Runcard</button>
                      <!-- <button class="btn btn-warning btn-sm" id="btnAddDefect" ><i class="fa fa-plus" ></i> Add Defect Escalation</button> -->
                    </div>
...
<!--                       <button class="btn btn-success btn-sm" id="btnPrintAccessory" data-toggle="modal" style="margin-bottom: 5px;"><i class="fa fa-print" ></i> Print Accessory</button>
 -->
    ...
    <!-- /.Modal Edit Prodn Lot Number -->
    <div class="modal fade" id="modalEditProdnLotNo" tabindex="-1">
      <div class="modal-dialog modal-sm modal-dialog-centered">
        <form class="modal-content" id="formEditProdnLotNo">
          @csrf
          <div class="modal-header">
            <h4 class="modal-title">Edit Prodn Lot No</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
          <input type="hidden" id="productionRuncardId" name="production_runcard_id">
            <div class="row">
              <div class="col">
                <div class="input-group input-group-sm">
                  ...
                  <input type="text" class="form-control form-control-sm" id="prodnLotNo" name="prodn_lot_no">
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                <div class="col">
                  <div class="input-group input-group-sm mb-3">
                    ...
                    {{-- <select class="form-control selAccessoryName" name="issuance_id" id="selSaveAccessoryName"> --}}
                      <!-- <option value=""> N/A </option> -->
                    </select>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col">
                  <div class="input-group input-group-sm mb-3">
                    ...
                    <input type="number" class="form-control form-control-sm" name="quantity" required id="_usage_per_socket" min="1">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col">
                  <div class="input-group input-group-sm mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm" name="usage_per_socket" required readonly id="_lot_quantity">
                  </div>
                </div>
              </div>
              <div class="row">
  ...
  <div class="modal fade" id="modal_to_inform_user_for_pilot_run" data-formid="" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header border-bottom-0 pb-0">
          <center><h5 class="modal-title"></i>Do you have a Pilot Run?</h5></center>
        </div>
        <!-- <div class="modal-body pt-0"> -->
          <!-- <div class="text-center text-secondary">
  ...
  <script type="text/javascript">
    ...
    let global_runcard_id = 0


    $(document).ready(function () {

      $('#_usage_per_socket').change(function() {
        $('#_lot_quantity').val( parseInt($('#_usage_per_socket').val()) * parseFloat( ($("#thRuncardTotalInput").html().replace('<b>', '')).replace('</b>', '') ) )
      })
...
// txt_yec_po_number_lbl
    function editProdnLotNo(){
        $.ajax({
            type: "POST",
            url: "update_prodn_rucard_lot_no",
            data: $('#formEditProdnLotNo').serialize(),
            dataType: "json",
            success: function (response) {
                if(response['is_success'] === 'true'){
                    $("#txtSearchPoTransLotNo").val('');
                    $("#txtSearchPoTransLotNo").focus();
                    $("#modalEditProdnLotNo").modal('hide');
                }
    ...
    $(document).on('click','#btnEditProdnLotNo', function () {
      let prodn_runcard_id=   $(this).attr('runcard-id');
      $.ajax({
            method: 'get',
            dataType: 'json',
            data: {
              prod_runcard_id: prodn_runcard_id
            },
            url       : 'get_prod_runcard_by_id',
            success     : function(data){
              $('#modalEditProdnLotNo').modal('show');
              $('#formEditProdnLotNo').find('[name=prodn_lot_no]').val(data.prod_runcard.runcard_no);
              $('#formEditProdnLotNo').find('[name=production_runcard_id]').val(data.prod_runcard.id);
            }
      });
    });
  ...
  $("#txt_yec_po_number_lbl").keyup(function (e) {
    ...
    //   GetMaterialKittingListByPoNo($(".selWBSMatKitItem"));
      ...
      $("select[name='issuance_id']", $("#frmSaveAccessory")).change(function(){
        ...
        // $("input[name='issuance_id']", $("#frmSaveAccessory")).val(itemDesc); usage_per_socket//item
        issuedQty = 1 * parseFloat( ($("#thRuncardTotalInput").html().replace('<b>', '')).replace('</b>', '') )
        console.log('itemDesc',itemDesc)
        console.log('issuedQty',issuedQty)
        console.log('usage',usage)
        $("input[name='quantity']", $("#frmSaveAccessory")).val(1);
      ...
      $("#btnAddProcess").click(function(){
        ...
        // $("#sel_edit_prod_runcard_ct_area").val('')
        // $("#sel_edit_prod_runcard_terminal_area").val('')

        // $('#sel_edit_prod_runcard_ct_area').val('').trigger('change');
        // $('#sel_edit_prod_runcard_terminal_area').val('').trigger('change');

        $("#txt_edit_prod_runcard_station_input").val(0)
        ...
        $.ajax({
            ...
            success: function(JsonObject){
                ...
                $('#sel_edit_prod_runcard_ct_area').select2();
                $('#sel_edit_prod_runcard_terminal_area').select2();

                $('#sel_edit_prod_runcard_ct_area').select2({ theme: 'bootstrap4' });
                ...
                str += '<table class="table1 text-middle" cellspacing="0" cellpadding="0" border="0">'
                  str += '<tbody>'
                    ...
                    str += '<tr>';
                      ...
                      str += '<td colspan="6">Product Name: <u class="bold" id="txtAccProdName">' + $('#lbl_device_name').attr('device_name_print') + '</u></td>';
                    str += '</tr>';
                    str += '<tr>';
      ...
      dt_prod_runcard      = $('#tbl_prod_runcard').DataTable({
        "processing" : true,
          ...
          "rowCallback": function(row,data,index ){
            ...
            // $('#txt_device_name_lbl').val( data['wbs_kitting']['device_name'] ); // commented 04-05-2024
            $('#txt_device_name_lbl').val( data['device_name'] );

            // alert(data['wbs_kitting']['device_name'])
            // $('#txt_po_qty_lbl').val( data['wbs_kitting']['po_qty'] ); // commented
          ...
          "drawCallback": function(row,data,index ){
            ...
            var last = null;
            console.log('object1 ', api.rows().count());
            console.log('object2 ', api.rows());
      ...
      dt_prod_runcard_stations = $('#tbl_prod_runcard_stations').DataTable({
        "processing" : true,
          ...
          "columns":[
            ...
            // { "data" : "runcard_no", orderable:false, searchable:true }, // from defect escalation no.
    ...
    $('#btnOverallInspection').click(function(){
          ...
          $.ajax({
            ...
            success: function(data){
              ...
              if( data['data'].length > 0 ){
                ...
                $("#txt_PMDoc_no").val($("#txt_PMDoc").val());//txt_orig_Adrawing_no
                ...
                $("#txt_po_qty").val( data['data'][0]['po_qty'])

                $("#txt_JRDJKSDCGJDoc_no").val( data['data'][0]['j_r_dj_ks_dc_gj'] )
                $("#txt_JRDJKSDCGJDoc_revision").val( data['data'][0]['j_r_dj_ks_dc_gj_revision'] )
                $("#txt_GPMDDoc_no").val( data['data'][0]['gp_md'] )
                $("#txt_GPMDDoc_revision").val( data['data'][0]['gp_md_revision'] )
              ...
              // console.log('poQty', $("#txt_po_number_lbl").val());
              ...
              $("#txt_orig_Adrawing_no").val($("#txt_orig_Adrawing").val());//txt_orig_Adrawing
              ...
              $('#btn_edit_material_details_primary').attr('hidden', false)
          ...
          success       : function(data){
            ...
            if ($.trim(data['doc'])){
              for(var ctr=0;ctr<data['doc'].length;ctr++){
                ...
                list+="<option value='"+data['doc'][ctr]['document_no']+"' data-revision='"+data['doc'][ctr]['rev']+"'>"+data['doc'][ctr]['document_no']+' '+data['doc'][ctr]['doc_title']+' '+data['doc'][ctr]['rev']+"</option>";
              }
            }
        ...
        $.ajax({
          ...
          success     : function(data){
              ...
              if(data['result'] == 1){
                ...
                global_runcard_id = data['prod_runcard_id']
                ...
                $.ajax({
                  ...
                  success   : function(data){
                    ...
                    if( data['result'] ){
                      ...
                      dt_prod_runcard.draw();
                      readonly_material_details_primary(true);
                      toastr.success('FVI', 'Successfully Saved!');
                      // location.reload()
                      $("#btn_edit_material_details_primary").attr( 'hidden', true );
                    }else{
      ...
      $("#tbl_prod_runcard").on('click','.btnOpenRuncardDetails',function(e){
        ...
        global_runcard_id = $(this).attr('runcard-id')
        checked_draw_count_reset()
      ...
      $(document).on('click','#btnSubmitToOQCLotApp',function(e){
        ...
        // if (confirm("do you want to submit this lot?") == true) {
        //   // submit_to_oqc_lot_app();
        // } else {
        //   alert('Submit to OQC Lot App is canceled.')
        // }

        $.ajax({
          'data'      : { id: global_runcard_id },
          'type'      : 'get',
          'dataType'  : 'json',
          'url'       : 'check_lot_qty_before_submit_to_oqc_lot_app',
          success     : function(data){
            if (confirm(data['question']) == true) {
              submit_to_oqc_lot_app();
            } else {
              alert('Submit to OQC Lot App is canceled.')
            }
      ...
      $('#frm_edit_prod_runcard_station_details').submit(function(e){
        ...
        if( $('#sel_edit_prod_runcard_ct_area').val() == 0 || $('#sel_edit_prod_runcard_ct_area').val() == ''  || $('#sel_edit_prod_runcard_ct_area').val() == null ){
          alert( 'CT Area is required.' )
          return
        }

        if( $('#sel_edit_prod_runcard_terminal_area').val() == 0 || $('#sel_edit_prod_runcard_terminal_area').val() == ''  || $('#sel_edit_prod_runcard_terminal_area').val() == null ){
          alert( 'Terminal Area is required.' )
          return
        }
      ...
      /*added by Nessa*/
    $(document).on('keypress',function(e){
      if( ($("#modalScan_EmployeeID").data('bs.modal') || {})._isShown ){
        $('#modalScan_EmployeeID_id').focus();

        if( e.keyCode == 13 && $('#modalScan_EmployeeID_id').val() !='' && ($('#modalScan_EmployeeID_id').val().length >= 4) ){
            $('#modalScan_EmployeeID').modal('hide');
          }
        }
    });
      ...
      $("#modalScan_EmployeeID_id").keydown(function (e) {
        if (e.keyCode == 13) {
          ...
          $.ajax({
            'data'      : {
              employee_id: $("#modalScan_EmployeeID_id").val(),
              position: 4,
              user_level_id: 4,
            },
            'type'      : 'get',
      ...
      $.ajax({
        ...
        $("#txt_pair_no").removeClass('is-invalid');
          ...
          if(data['prod_runcard'] != null){
            ...
            $("#txt_po_qty").val( data['prod_runcard']['po_qty'] )

            $("#txt_JRDJKSDCGJDoc_no").val( data['prod_runcard']['j_r_dj_ks_dc_gj'] )
            $("#txt_JRDJKSDCGJDoc_revision").val( data['prod_runcard']['j_r_dj_ks_dc_gj_revision'] )
            $("#txt_GPMDDoc_no").val( data['prod_runcard']['gp_md'] )
            $("#txt_GPMDDoc_revision").val( data['prod_runcard']['gp_md_revision'] )
            ...
            $("#txt_orig_Adrawing_no").val(data['prod_runcard']['orig_a_drawing_no']);
            $("#orig_a_revision").val(data['prod_runcard']['orig_a_revision']);
    ...
    function check_btnSubmitToOQCLotApp_if_disabled() {
      ...
      setTimeout(() => {
        ...
        // }
          ...
          $.ajax({
            url : 'checkQuantityOutputIsComplete',
            method : 'get',
            data: {
              id: global_runcard_id
            },
            dataType : 'json',
            before: function(){
            },
        ...
        // alert( global_runcard_id )
        // alert( parseInt( $('#thRuncardTotalOutput').html().split('<b>')[1].split('</b>')[0] ) )
      }, 3000)
    }
...
// -------------------------------------------------------------------------------
  ...
  $(".btnSearchADrawing").click(function(){
    ...
    if ( txt_Adrawing == 'N/A'){
      alert('No Document Required Required')
      $('.btnSearchADrawing').prop('disabled', true);

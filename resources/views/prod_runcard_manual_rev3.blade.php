  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>FVI / Lot Applicationssssssss</h1>
          </div>
          <div class="col-sm-6">
                 ...
                 <div class="col-sm-3">
                  ...
                  <div class="col-sm-2">
                    <label>A Drawing</label>
                      <input type="text" class="form-control" id="txt_Adrawing" readonly="">
                  </div>
                  <div class="col-sm-1">
                  ...
                  <div class="col-sm-2">
                    <label>G Drawing</label>
                      <input type="text" class="form-control" id="txt_Gdrawing" readonly="">
                  </div>
                  <div class="col-sm-1">
                    <label>Revision</label>
                  ...
                  <div class="col-sm-2">
                    <label>Other Drawing</label>
                      <input type="text" class="form-control" id="txt_Odrawing" readonly="">
                  </div>
                  <div class="col-sm-1">
                    <label>Revision</label>

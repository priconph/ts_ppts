...
<style type="text/css">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Final Packing Inspection - Operator/QC (WEB EDI)</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
            <li class="breadcrumb-item active">Final Packing Inspection - Operator/QC (WEB EDI)</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <!-- /.card -->
           ...
           <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">2. Final Packing Inspection - Operator/QC (WEB EDI) Summary</h3>
              </div>
                <div class="card-body">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Final Packing Inspection - Operator/QC (WEB EDI)</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>

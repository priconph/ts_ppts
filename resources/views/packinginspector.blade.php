...
@auth
          ...
          <div class="modal-body">
            ...
            <form method="post" id="formPackingInspector">
              ...
              <div class="col-sm-4 p-2">
                ...
                <h6><strong>Check Attached C3 Label vs Records</strong></h6>
                      <div class="row">
                        <div class="col">
              ...
              <div class="col-sm-4 p-2">
                ...
                <h6><strong>Does the product require accessories?</strong></h6>
 ...
 <div class="modal fade" id="modalPackingInspectorHistory">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">

         <div class="modal-header">
            <h4 class="modal-title"><i class="fa fa-checklist"></i> Preliminary QC Packing Inspection History</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
   ...
   $(document).on('keyup','#txt_search_po_number',function(e){
    ...
    $(document).on('keypress',function(e){
     ...
     $(document).on('click','#btn_save_packin',function(e){
      ...
      //CHECK C3 DEVICE
       $(document).on('keyup', '.c_label_check_device', function(e) {
        ...
        if( e.keyCode == 13 ){
            ...
            var input_device_2 = "id_device_" + id;
            ...
            if($(input_device).val() != '')
            {
              if($(input_device).val() == $(hidden_device).val())
              {
                ...
                document.getElementById(input_device_2).style.border = '2px solid green';
              }
              else
              {
                $(status_device).val('2');
                $(status_device).change();
                document.getElementById(input_device_2).style.border = '2px solid red';
              }
            }
            else
            {
              $(status_device).val('');
              $(status_device).change();
              document.getElementById(input_device_2).style.border = '';
            }
       ...
       //CHECK C3 MANUFACTURE
        ...
        if( e.keyCode == 13 ){
            ...
            var input_manufacture_2 = "id_manufacture_" + id;
            ...
            if($(input_manufacture).val() != '')
            {
                if($(input_manufacture).val() == $(hidden_manufacture).val())
                {
                  ...
                  $(status_manufacture).change();
                   document.getElementById(input_manufacture_2).style.border = '2px solid green';
                }
                else
                {
                  $(status_manufacture).val('2');
                  $(status_manufacture).change();
                   document.getElementById(input_manufacture_2).style.border = '2px solid red';
                }
            }
            else
            {
              ...
              $(status_manufacture).change();
               document.getElementById(input_manufacture_2).style.border = '2';
            }
        ...
        if( e.keyCode == 13 ){
            ...
            var input_quantity_2 = "id_quantity_" + id;
              ...
              if($(input_quantity).val() != '')
              {
                if($(input_quantity).val() == $(hidden_quantity).val())
                {
                  ...
                  document.getElementById(input_quantity_2).style.border = '2px solid green';
                }
                else
                {
                  $(status_quantity).val('2');
                  $(status_quantity).change();
                  document.getElementById(input_quantity_2).style.border = '2px solid red';
                }
              }
              else
              {
                $(status_quantity).val('');
                $(status_quantity).change();
                document.getElementById(input_quantity_2).style.border = '';
              }
            }
        });
        ...
        if( e.keyCode == 13 ){
            ...
            var input_lot_no_2 = "id_lot_no_" + id;
            ...
            if($(input_lot_no).val() != '')
            {
              if($(input_lot_no).val() == $(hidden_lot_no).val())
              {
                  ...
                  document.getElementById(input_lot_no_2).style.border = '2px solid green';
              }
              else
              {
                  $(status_lot_no).val('2');
                  $(status_lot_no).change();
                  document.getElementById(input_lot_no_2).style.border = '2px solid red';
              }
            }
            else
            {
              $(status_lot_no).val('');
              $(status_lot_no).change();
              document.getElementById(input_lot_no_2).style.border = '';
            }

            var device = "id_device_" + next_id;
      ...
      $('.hidden_c3_check').on('change', function()
      {

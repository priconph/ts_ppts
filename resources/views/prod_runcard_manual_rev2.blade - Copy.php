                    ...
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        <div class="input-group-prepend w-50">
                          ...
                          <!-- <input type="text" class="form-control" id="txt_OGMVIGIGDoc_no" name="txt_OGMVIGIGDoc_no" > -->
                  ...
                  <div class="row row_container">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" value="N/A" class="form-control form-control-sm" id="txt_PPDoc_revision" name="txt_PPDoc_revision" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="row row_container">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" value="N/A" class="form-control form-control-sm" id="txt_UDDoc_revision" name="txt_UDDoc_revision" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="row row_container">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" value="N/A" class="form-control form-control-sm" id="txt_PMDoc_revision" name="txt_PMDoc_revision" readonly>
                      </div>
                    </div>
                  </div>
                  <div class="row row_container">

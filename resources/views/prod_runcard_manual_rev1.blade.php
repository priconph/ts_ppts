                      ...
                      <table class="table table-sm table-bordered table-hover" id="tbl_prod_runcard" style="min-width: 900px;">
                        <thead>
                          <tr class="bg-light">
                            ...
                            <th>Lot Qty</th>
                            <th>Pair #</th>
                            <th>Setup Qualification</th>
                            <!-- <th>Qualified</th> -->
                            <th>Engineer / Technician</th>
                            <th>QC Qualification</th>
                            <th>Result</th>
                            <th>QC Inspector</th>
                            <th class="bg-info">OK</th>
                ...
                <form id="frm_edit_material_details" method="post">
                  <div class="row">
                    <div class="col pt-3">
                      ...
                      <span class="badge badge-secondary">1.</span> Product Qualification
                    </div>
                  </div>
                  <!-- <div class="row">
                    <div class="col">
                  ...
                  <!-- <div class="row">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        <div class="input-group-prepend w-50">
                          <span class="input-group-text w-100">For Qualification?</span>
                        </div>
                        <select class="form-control" name="for_qualification" disabled="true">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        <div class="input-group-prepend w-50">
                          <span class="input-group-text w-100">Setup Qualification</span>
                        </div>
                        <select class="form-control" name="setup_qualification" disabled="true">
                          <option value="1" selected="true">Yes</option>
                          <option value="0">No</option>
                        </select>
                      </div>
                    ...
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        <div class="input-group-prepend w-40">
                          <span class="input-group-text w-80">Engineer / Techinician</span>
                        </div>
                        <input type="text" class="form-control form-control-sm" name="eng_qualification_name" readonly>
                        <input type="text" class="form-control form-control-sm" name="eng_qualification_id" readonly style="display: none;">
                        <button class="btn btn-xs btn-primary input-group-append btnSelEngQual" type="button" disabled="true" style="padding: 5px 8px; padding-top: 8px;"><i class="fa fa-qrcode"></i></button>
                        <button class="btn btn-xs btn-danger input-group-append btnClearEngQual" type="button" disabled="true" style="padding: 5px 8px; padding-top: 8px;" title="Remove Engineer / Techinician"><i class="fa fa-times"></i></button>
                      </div>
                    </div>
                  </div>
                  ...
                  <!-- <div class="row">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        <div class="input-group-prepend w-50">
                          <span class="input-group-text w-100">Qualified?</span>
                        </div>
                        <select class="form-control" name="setup_qualified" disabled="true">
                          <option value="1" selected="true">Yes</option>
                          <option value="0">No</option>
                        </select>
                      </div>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        <div class="input-group-prepend w-50">
                          <span class="input-group-text w-100">QC Qualification</span>
                        </div>
                        <select class="form-control" name="qc_qualification" disabled="true">
                          <option value="1" selected="true">Yes</option>
                          <option value="0">No</option>
                        </select>
                      </div>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        <div class="input-group-prepend w-40">
                          <span class="input-group-text w-80">QC Inspector</span>
                        </div>
                        <input type="text" class="form-control form-control-sm" name="qc_stamp_name" readonly>
                        <input type="text" class="form-control form-control-sm" name="qc_stamp_id" readonly style="display: none;">
                        <button class="btn btn-xs btn-primary input-group-append btnSelQCStamp" type="button" disabled="true" style="padding: 5px 8px; padding-top: 8px;"><i class="fa fa-qrcode"></i></button>
                        <button class="btn btn-xs btn-danger input-group-append btnClearQCStamp" type="button" disabled="true" style="padding: 5px 8px; padding-top: 8px;" title="Remove QC Inspector"><i class="fa fa-times"></i></button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        <div class="input-group-prepend w-50">
                          <span class="input-group-text w-100">QC Qualification Result</span>
                        </div>
                        <select class="form-control" name="qc_qualified" disabled="true">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        ...
                        <textarea class="form-control form-control-sm" id="txt_qc_remarks" name="qc_remarks" rows="5" readonly></textarea>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col">
                      <hr>
                      <span class="badge badge-secondary">2.</span> Runcard Details
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col border py-3 px-4 border-left-0 border-bottom-0">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                      ...
                      <!-- <li class="nav-item">
                        <a class="nav-link" id="accessories-tab" data-toggle="tab" href="#accessories" role="tab" aria-controls="accessories" aria-selected="true">Accessories</a>
                      </li> -->
                      <!-- <li class="nav-item">
                    ...
                    <div class="tab-content" id="myTabContent">
                      ...
                      <div class="tab-pane fade my-2" id="accessories" role="tabpanel" aria-labelledby="accessories-tab">
                        <!-- <center>
                          <label>Materials</label>
                        </center> -->
                        ...
                        <div class="table-responsive" style="max-height: 500px;">
                          ...
                          <div style="float: left;">
                            <div class="input-group input-group-sm">
                              <button type="button" class="btn btn-sm btn-success" id="btnAddAccessories"><i class="fa fa-plus"></i> Add Accessories</button>
                            </div>
                          </div>
                          <table class="table table-sm table-bordered table-hover small" id="tbl_accessories" style="min-width: 900px;">
                            <thead>
                              <tr class="bg-light">
                                <th>Accessories</th>
                                <th>Lot No.</th>
              ...
              <div class="row">
                <div class="col">
                  <div class="input-group input-group-sm mb-3">
                    ...
                    <input type="number" class="form-control form-control-sm" id="txt_edit_prod_runcard_station_input" name="qty_input" min="0">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col">
                  <div class="input-group input-group-sm mb-3">
                    ...
                    <input type="number" class="form-control form-control-sm" id="txt_edit_prod_runcard_station_output" name="qty_output" min="0">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col">
                  <div class="input-group input-group-sm mb-3">
                    ...
                    <input type="number" class="form-control form-control-sm" id="txt_edit_prod_runcard_station_ng" name="qty_ng" min="0" value="0" readonly="true">
                  </div>
                </div>
              </div>
              <hr>
    ...
    ***************************************************************************/
      ...
      dt_prod_runcard      = $('#tbl_prod_runcard').DataTable({
        "processing" : true,
          ...
          "columns":[
            ...
            { "data" : "lot_qty" },
            { "data" : "pair_no" },
            { "data" : "raw_setup_qualification" },
            // { "data" : "raw_setup_qualified" },
            { "data" : "raw_eng_qualification_id" },
            { "data" : "raw_qc_qualification" },
            { "data" : "raw_qc_qualified" },
            { "data" : "raw_qc_stamp_qualification_info" },
            { "data" : "last_runcard_po_qty" },
            { "data" : "total_no_of_ng" },
    ...
    $('#btnOverallInspection').click(function(){
        ...
        $.ajax({
          ...
          success     : function(data){
              ...
              if(data['result'] == 1){
                ...
                dt_prod_runcard.draw();
                readonly_material_details_primary(true);
                toastr.success('Production Runcard', 'Saved Successfully!');
              }
              else if(data['result'] == 2){
                toastr.warning('Production Runcard', 'Scanned Operator not found!');
              }
              else if(data['result'] == 0){
                toastr.error('Production Runcard', 'Saving Failed!');
                if(data['error'] != null){
      ...
      $('#frm_edit_prod_runcard_station_details').submit(function(e){
        ...
        $.ajax({
          'data'      : $(this).serialize() +'&txt_employee_number_scanner=' + $("#txt_employee_number_scanner").val() +'&txt_prod_runcard_id_query=' + $("#txt_prod_runcard_id_query").val() +'&selected_prod_runcard=' + arrSelectedRuncards,
          'type'      : 'post',
          'dataType'  : 'json',

      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Shipment Summary</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
                    ...
                    <div class="col-sm-3">
                      ...
                      <div class="input-group">
                        <!-- <div class="input-group-prepend">
                         ...
                         <!-- <input type="text" id="id_po_no" class="form-control"> -->
                         <input type="text" id="id_packing_list_no" class="form-control">
...
<!--                     <div class="col-sm-2">
 ...
 -->                  </div>
          ...
          <!-- /.card -->
           ...
           <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">2. Shipment Summary</h3>
              </div>
                <div class="card-body">
                   <div class="table-responsive dt-responsive">
                      <table id="tbl_shipment_summary" class="table table-bordered table-striped table-hover" style="width: 100%;">
                          <thead>
                            <tr>
                              <th>Status (Balance Qty)</th>
        ...
        <input type="hidden" name="finalpacking_mode" value="oqc">
          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="card card-primary">
                <div class="card-header">
                <h5 class="card-title">Final Packing Details</h5>
              ...
              <div class="card card-primary">
                <div class="card-header">
                <h5 class="card-title">DLabel Details</h5>
              ...
              <div class="card card-primary">
                <div class="card-header">
                <h5 class="card-title">Casemark Details</h5>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body pt-0">
        <div class="text-center text-secondary">
          ...
          <p style="font-size:50px; color:red;">Invalid <b>DLABEL</b> QR Code Details, Please check!</p>
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    $('#id_packing_list_no').keypress(function(e) {
      if( e.keyCode == 13 && $('#id_packing_list_no').val() !='' ){
    ...
    $('#btn_scan_tray_3').click(function() {
      ...
      if( dlabel_to_scan[4] == 1 ){
        alert( 'DLabel details already scanned.' )
        return
      } 
    ...
    $('#modal_scan_tray_qrcode_2').keypress(function(e) {
     ...
     GetUserList($(".selectUser"));
      ...
      dt_final_inspection = $('#tbl_shipment_summary').DataTable({
          "processing"    : false,
          "serverSide"  : true,
          "ajax"        : 
          {
            url: "load_packinglist_scanned_summary",
              data: function (param){
                  // param.packing_list_ctrl_no = $("#id_packing_list_no").val()
                  param.po_no = $("#id_packing_list_no").val()
                }
          },

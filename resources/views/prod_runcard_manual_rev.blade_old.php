  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>FVI / Lot Application</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
              <li class="breadcrumb-item">FVI</li>
              <li class="breadcrumb-item active">Lot Application</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <div class="float-right">
                      ...
                      <button class="btn btn-primary btn-sm" id="btnShowAddProdRuncard" disabled><i class="fa fa-plus"></i> Add Lot Application</button>
                    </div>
                    <br><br>
      ...
      <div class="modal-dialog modal-xl modal-xl-custom modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title"><i class="fa fa-info-circle text-info"></i> FVI Details</h5>
                ...
                <form id="frm_edit_material_details" method="post">
                  ...
                  <div class="row">
                    <div class="col pt-3">
                      ...
                      <span class="badge badge-secondary">1.</span> FVI Details
                    </div>
                  </div>
                  ...
                  <div class="row row_container">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" class="form-control txt_a_drawing" list="dl_a_drawing_no" id="a_drawing_no" name="a_drawing_no" autocomplete="off" onkeyup="this.value = this.value.toUpperCase();" disabled>
                        <datalist class="dl_a_drawing" id="dl_a_drawing_no"></datalist>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row row_container">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" class="form-control txt_g_drawing" list="dl_g_drawing_no" id="g_drawing_no" name="g_drawing_no" autocomplete="off" onkeyup="this.value = this.value.toUpperCase();" disabled>
                        <datalist class="dl_g_drawing" id="dl_g_drawing_no"></datalist>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row row_container">
                    <div class="col">
                      <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" class="form-control txt_o_drawing" list="dl_o_drawing_no" id="o_drawing_no" name="o_drawing_no" autocomplete="off" onkeyup="this.value = this.value.toUpperCase();" disabled>
                        <datalist class="dl_o_drawing" id="dl_o_drawing_no"></datalist>
                      </div>
                    </div>
                  </div>
                  <div class="row">
...
function OutputDataCounter(api) {
      ...
      $.ajax({
        ...
        success: function(data){
          if(data['material_kitting'] != null){
            ...
            // $("#a_drawing_no").val(data['doc_a_drawing_query'][0]['doc_no']);
            // $("#g_drawing_no").val(data['doc_g_drawing_query'][0]['doc_no']);
      ...
      $.ajax({
        ...
        $("#txt_pair_no").removeClass('is-invalid');
          ...
          if(data['prod_runcard'] != null){
            ...
            $("#a_drawing_no").val(data['prod_runcard']['a_drawing_no']);
            $("#a_revision").val(data['prod_runcard']['a_revision']);
            $("#g_drawing_no").val(data['prod_runcard']['g_drawing_no']);
            $("#g_revision").val(data['prod_runcard']['g_revision']);
            $("#o_drawing_no").val(data['prod_runcard']['o_drawing_no']);
    ...
    $("#btn_print_drawing").click(function(){
        if($("#a_drawing_no").val() == "" || $("#a_drawing_no").val() == null || $("#g_drawing_no").val() == "" || $("#g_drawing_no").val() == null || $("#o_drawing_no").val() == "" || $("#o_drawing_no").val() == null || $("#a_revision").val() == "" || $("#a_revision").val() == null || $("#g_revision").val() == "" || $("#g_revision").val() == null || $("#o_revision").val() == "" || $("#o_revision").val() == null){
          toastr.warning('A, G or Other Drawing not found!');
        
        }else{
          $("#modal_Drawing_QRcode").modal('show');

            if ($('#a_drawing_no').val() == '' || $('#a_drawing_no').val() == null || $('#a_drawing_no').val() == "N/A" || $('#a_revision').val() == "N/A"){
              ...
              // lbl_device_name_odrawing   = $('#txt_device_name_lbl').val();   
              lbl_device_name_adrawing   = $('#lbl_device_name').attr('device_name_print');
              lbl_adrawing_no            = $('#a_drawing_no').val();  
              lbl_a_revision             = $('#a_revision').val();  
            ...
            if ($('#g_drawing_no').val() == '' || $('#g_drawing_no').val() == null || $('#g_drawing_no').val() == "N/A" || $('#g_revision').val() == "N/A"){
              ...
              lbl_gdrawing_no            = $('#g_drawing_no').val();  
              lbl_g_revision             = $('#g_revision').val();  
            ...
            if ($('#o_drawing_no').val() == '' || $('#o_drawing_no').val() == null || $('#o_drawing_no').val() == "N/A" || $('#o_revision').val() == "N/A"){
              ...
              lbl_odrawing_no            = $('#o_drawing_no').val();  
              lbl_o_revision             = $('#o_revision').val();  
          ...
          //-Qr code
            $.ajax({
              ...
              success: function(data){
                console.log(data)
              /*  if(lbl_adrawing_no != 'N/A' || lbl_adrawing_no != ''){
                ...
                if(lbl_gdrawing_no != 'N/A' || lbl_gdrawing_no != ''){
             ...
             /*   if(lbl_odrawing_no != 'N/A' || lbl_odrawing_no != ''){
  ...
  $("#btnReference").click(function(){
    ...
    // alert(device_name)
    window.open("http://rapid/ACDCS/prdn_home_tspts?doc_title="+device_name);    

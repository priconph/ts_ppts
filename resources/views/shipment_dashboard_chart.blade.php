      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Shipment Dashboard</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <!-- left column -->
            ...
            <!-- Start Page Content -->
                ...
                <iframe src="http://rapidx/ts_shipment_confirmation/chart?en={{Auth::user()->employee_id}}&pos={{Auth::user()->position}}"  style="height: 80vh; width: 100%; border: none;"></iframe>
